...
export const supplyEmissionsCurrentEpoch = new Map<string, BigInt>();
supplyEmissionsCurrentEpoch.set("0x35a18000230da775cac24873d00ff85bccded550", BigInt.fromString("3396947613139741"));
supplyEmissionsCurrentEpoch.set("0x39aa39c021dfbae8fac545936693ac917d5e7563", BigInt.fromString("85816641405316611"));
supplyEmissionsCurrentEpoch.set("0x4ddc2d193948926d02f9b1fe9e1daa0718270ed5", BigInt.fromString("15405832570580501"));
supplyEmissionsCurrentEpoch.set("0x5d3a536e4d6dbd6114cc1ead35777bab948e3643", BigInt.fromString("78346946985523116"));
supplyEmissionsCurrentEpoch.set("0x70e36f6bf80a52b3b46b3af8e106cc0ed743e8e4", BigInt.fromString("7312282725587365"));
supplyEmissionsCurrentEpoch.set("0x7713dd9ca933848f6819f38b8352d9a15ea73f67", BigInt.fromString("251323011482380"));
supplyEmissionsCurrentEpoch.set("0xccf4429db6322d5c611ee964527d42e5d685dd6a", BigInt.fromString("32641726328254251"));
supplyEmissionsCurrentEpoch.set("0xf650c3d88d12db855b8bf7d11be6c55a4e07dcc9", BigInt.fromString("69254489643924614"));
...
export const borrowEmissionsCurrentEpoch = new Map<string, BigInt>();
borrowEmissionsCurrentEpoch.set("0x35a18000230da775cac24873d00ff85bccded550", BigInt.fromString("7862408081721847"));
borrowEmissionsCurrentEpoch.set("0x39aa39c021dfbae8fac545936693ac917d5e7563", BigInt.fromString("198532733695136045"));
borrowEmissionsCurrentEpoch.set("0x4ddc2d193948926d02f9b1fe9e1daa0718270ed5", BigInt.fromString("177167074561675766"));
borrowEmissionsCurrentEpoch.set("0x5d3a536e4d6dbd6114cc1ead35777bab948e3643", BigInt.fromString("156717400405785364"));
borrowEmissionsCurrentEpoch.set("0x70e36f6bf80a52b3b46b3af8e106cc0ed743e8e4", BigInt.fromString("5062539961140279"));
borrowEmissionsCurrentEpoch.set("0x7713dd9ca933848f6819f38b8352d9a15ea73f67", BigInt.fromString("251323011482380"));
borrowEmissionsCurrentEpoch.set("0xccf4429db6322d5c611ee964527d42e5d685dd6a", BigInt.fromString("65293246153756703"));
borrowEmissionsCurrentEpoch.set("0xf650c3d88d12db855b8bf7d11be6c55a4e07dcc9", BigInt.fromString("74546360945619850"));
