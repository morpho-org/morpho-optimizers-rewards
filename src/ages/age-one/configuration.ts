...
export default {
  ...
  epochs: {
    ...
    epoch2: {
      initialBlock: 14927832, // https://etherscan.io/block/14927832 TODO: change block
      ...
      subgraphUrl: "https://api.thegraph.com/subgraphs/name/morpho-labs/morphoagesepoch2",
      epochName: "epoch2",
    },
  },
};
